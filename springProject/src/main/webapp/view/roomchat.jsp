...
<div class="roomchat_wrap">
	...
	<div class="col-12" style="margin-top: 10px;">
		<div class="col-12" style="float: left">
			<textarea class="form-control"
				style="border: 1px solid #dddddd; height: 65px; float: left; width: 80%" placeholder="Enter ..." id="message"></textarea>
	...
	<script type="text/javascript">
		...
		function connect() {
			...
			sock = new SockJS("http://211.63.89.82:8080/SpringProject33/chat");
