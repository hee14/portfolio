...
function init(){
	...
	var confmKey = "devU01TX0FVVEgyMDIwMDMwNjAwNTQwMzEwOTUyMTk=";
	...
	if(inputYn != "Y"){
		...
		document.member.action="http://www.juso.go.kr/addrlink/addrLinkUrl.do"; //인터넷망
...
<body onload="init();">
	<form id="usercheck" name="member" method = "post">
